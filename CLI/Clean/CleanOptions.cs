...
namespace GCodeCleanCLI.Clean
{
    public static class CleanOptions {
        ...
        public static (decimal tolerance, decimal arcTolerance, decimal zClamp) Constrain(decimal tolerance, decimal arcTolerance, decimal zClamp) {
            tolerance = ConstrainOption(tolerance, 0.00005M, 0.5M, "Clipping and general mathematical tolerance:");
            arcTolerance = ConstrainOption(arcTolerance, 0.00005M, 0.5M, "Arc simplification tolerance:");
            zClamp = ConstrainOption(zClamp, 0.02M, 10.0M, "Z-axis clamping value (max traveling height):");
